        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="bg-white rounded-lg shadow-sm p-8 md:p-12">
            ...
            <section className="mb-8">
              ...
              <p className="text-gray-700 mb-3">By using Emotion Buddy, you acknowledge that:</p>
            ...
            <section className="mb-8">
              ...
              <p className="text-gray-700 mb-3">Emotion Buddy provides:</p>
              <ul className="list-disc pl-6 text-gray-700 mb-4 space-y-1">
            ...
            <section className="mb-8">
              ...
              <h3 className="text-xl font-semibold text-gray-800 mb-3">4.3 Content Standards</h3>
              <p className="text-gray-700 mb-3">While your journal is private, you agree not to:</p>
              <ul className="list-disc pl-6 text-gray-700 mb-4 space-y-1">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-bold text-gray-900 mb-4">5. AI Features and Third-Party Services</h2>

              <h3 className="text-xl font-semibold text-gray-800 mb-3">5.1 AI Analysis</h3>
              <p className="text-gray-700 mb-4">
              ...
              <h3 className="text-xl font-semibold text-gray-800 mb-3">5.2 Limitations of AI</h3>
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-bold text-gray-900 mb-4">6. Not Medical Advice</h2>
            ...
            <section className="mb-8">
              ...
              <p className="text-gray-700 mb-3">Key privacy commitments:</p>
              <ul className="list-disc pl-6 text-gray-700 mb-4 space-y-1">
            ...
            <section className="mb-8">
              ...
              <h3 className="text-xl font-semibold text-gray-800 mb-3">8.2 Future Paid Features</h3>
              <p className="text-gray-700 mb-4">
            ...
            <section className="mb-8">
              ...
              <h3 className="text-xl font-semibold text-gray-800 mb-3">9.2 Your Rights</h3>
              <p className="text-gray-700 mb-3">
            ...
            <section className="mb-8">
              ...
              <h3 className="text-xl font-semibold text-gray-800 mb-3">14.2 By Us</h3>
              <p className="text-gray-700 mb-3">

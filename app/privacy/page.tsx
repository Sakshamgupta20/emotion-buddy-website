        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="glass-card p-8 md:p-12">
            ...
            <section className="mb-8">
              ...
              <h3 className="text-xl font-semibold text-gray-200 mb-3">1.1 Account Information</h3>
              ...
              <h3 className="text-xl font-semibold text-gray-200 mb-3">1.2 Journal Data</h3>
              <p className="text-gray-300 mb-3">As part of our core service, we collect and store:</p>
              <ul className="list-disc pl-6 text-gray-300 mb-4 space-y-1">
              ...
              <h3 className="text-xl font-semibold text-gray-200 mb-3">1.3 Usage Data</h3>
              <p className="text-gray-300 mb-3">We automatically collect:</p>
              <ul className="list-disc pl-6 text-gray-300 mb-4 space-y-1">
              ...
              <h3 className="text-xl font-semibold text-gray-200 mb-3">1.4 Information We Do NOT Collect</h3>
              <ul className="list-disc pl-6 text-gray-300 mb-4 space-y-1">
                <li>Location data</li>
                <li>Contact lists</li>
            ...
            <section className="mb-8">
              ...
              <h3 className="text-xl font-semibold text-gray-200 mb-3">2.1 To Provide Our Services</h3>
              <ul className="list-disc pl-6 text-gray-300 mb-4 space-y-1">
              ...
              <h3 className="text-xl font-semibold text-gray-200 mb-3">2.2 To Improve Our App</h3>
              <ul className="list-disc pl-6 text-gray-300 mb-4 space-y-1">
              ...
              <h3 className="text-xl font-semibold text-gray-200 mb-3">2.3 To Communicate With You</h3>
              <ul className="list-disc pl-6 text-gray-300 mb-4 space-y-1">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-bold text-gray-100 mb-4">3. How We Share Your Information</h2>

              <h3 className="text-xl font-semibold text-gray-200 mb-3">3.1 Third-Party Services</h3>

              <div className="mb-4">
                <h4 className="font-semibold text-gray-200 mb-2">OpenAI API</h4>
              ...
              <div className="mb-4">
                <h4 className="font-semibold text-gray-200 mb-2">Cloud Storage</h4>
                <ul className="list-disc pl-6 text-gray-300 space-y-1">
              ...
              <h3 className="text-xl font-semibold text-gray-200 mb-3">3.2 What We Never Share</h3>
              <ul className="list-disc pl-6 text-gray-300 mb-4 space-y-1">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-bold text-gray-100 mb-4">4. Data Security</h2>

              <h3 className="text-xl font-semibold text-gray-200 mb-3">4.1 Security Measures</h3>
              <p className="text-gray-300 mb-3">We implement industry-standard security practices:</p>
              <ul className="list-disc pl-6 text-gray-300 mb-4 space-y-1">
              ...
              <h3 className="text-xl font-semibold text-gray-200 mb-3">4.2 Your Responsibility</h3>
              <ul className="list-disc pl-6 text-gray-300 mb-4 space-y-1">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-bold text-gray-100 mb-4">5. Data Retention</h2>

              <h3 className="text-xl font-semibold text-gray-200 mb-3">5.1 Active Accounts</h3>
              ...
              <h3 className="text-xl font-semibold text-gray-200 mb-3">5.2 Deleted Accounts</h3>
              <p className="text-gray-300 mb-3">When you delete your account:</p>
              <ul className="list-disc pl-6 text-gray-300 mb-4 space-y-1">
              ...
              <h3 className="text-xl font-semibold text-gray-200 mb-3">5.3 Legal and Regulatory Requirements</h3>
              <p className="text-gray-300 mb-4">
            ...
            <section className="mb-8">
              ...
              <h3 className="text-xl font-semibold text-gray-200 mb-3">6.1 Right to Access</h3>
              <p className="text-gray-300 mb-3">
              ...
              <h3 className="text-xl font-semibold text-gray-200 mb-3">6.2 Right to Download (Data Portability)</h3>
              <p className="text-gray-300 mb-3">
              ...
              <h3 className="text-xl font-semibold text-gray-200 mb-3">6.3 Right to Delete</h3>
              <p className="text-gray-300 mb-3">
              ...
              <h3 className="text-xl font-semibold text-gray-200 mb-3">6.4 Right to Opt-Out</h3>
              <p className="text-gray-300 mb-3">
              ...
              <h3 className="text-xl font-semibold text-gray-200 mb-3">6.5 How to Exercise Your Rights</h3>
              <p className="text-gray-300 mb-3">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-bold text-gray-100 mb-4">6.5 Data Breach Notification</h2>
              <p className="text-gray-300 mb-4">
              ...
              <h3 className="text-xl font-semibold text-gray-200 mb-3">Our Commitment</h3>
              <ul className="list-disc pl-6 text-gray-300 mb-4 space-y-1">
              ...
              <h3 className="text-xl font-semibold text-gray-200 mb-3">How We'll Notify You</h3>
              <ul className="list-disc pl-6 text-gray-300 mb-4 space-y-1">
              ...
              <h3 className="text-xl font-semibold text-gray-200 mb-3">What We'll Tell You</h3>
              <ul className="list-disc pl-6 text-gray-300 mb-4 space-y-1">
              ...
              <h3 className="text-xl font-semibold text-gray-200 mb-3">Steps You Should Take</h3>
              <p className="text-gray-300 mb-3">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-bold text-gray-100 mb-4">6.6 Cookies and Tracking</h2>

              <h3 className="text-xl font-semibold text-gray-200 mb-3">This Website</h3>
              <p className="text-gray-300 mb-3">
              ...
              <h3 className="text-xl font-semibold text-gray-200 mb-3">The Mobile App</h3>
              <p className="text-gray-300 mb-4">
              ...
              <h3 className="text-xl font-semibold text-gray-200 mb-3">Third-Party Analytics</h3>
              <p className="text-gray-300 mb-3">
              ...
              <h3 className="text-xl font-semibold text-gray-200 mb-3">Your Control</h3>
              <ul className="list-disc pl-6 text-gray-300 mb-4 space-y-1">
            ...
            <section className="mb-8" id="account-deletion">
              <h2 className="text-2xl font-bold text-gray-100 mb-4">7. Account Deletion</h2>

              <h3 className="text-xl font-semibold text-gray-200 mb-3">7.1 How to Delete Your Account</h3>
              <p className="text-gray-300 mb-3">
                You can permanently delete your Emotion Buddy account at any time using our in-app deletion feature.
              </p>

              <p className="text-gray-300 mb-2"><strong>Steps to Delete Your Account:</strong></p>
              ...
              <h3 className="text-xl font-semibold text-gray-200 mb-3">7.2 What Gets Deleted</h3>
              <p className="text-gray-300 mb-3">When you delete your account, the following data is permanently removed:</p>

              <div className="mb-4">
                <h4 className="font-semibold text-gray-200 mb-2">Personal Data:</h4>
                <ul className="list-disc pl-6 text-gray-300 space-y-1">
              ...
              <div className="mb-4">
                <h4 className="font-semibold text-gray-200 mb-2">Journal Content:</h4>
                <ul className="list-disc pl-6 text-gray-300 space-y-1">
              ...
              <div className="mb-4">
                <h4 className="font-semibold text-gray-200 mb-2">Media Files:</h4>
                <ul className="list-disc pl-6 text-gray-300 space-y-1">
              ...
              <h3 className="text-xl font-semibold text-gray-200 mb-3">7.3 Deletion Timeline</h3>
              <p className="text-gray-300 mb-2"><strong>Immediate Actions:</strong></p>
              <ul className="list-disc pl-6 text-gray-300 mb-4 space-y-1">
              ...
              <p className="text-gray-300 mb-2"><strong>Within 90 Days:</strong></p>
              <ul className="list-disc pl-6 text-gray-300 mb-4 space-y-1">
            ...
            <section className="mb-8">
              ...
              <h3 className="text-xl font-semibold text-gray-200 mb-3">9.1 Data Location</h3>
              <ul className="list-disc pl-6 text-gray-300 mb-4 space-y-1">
                <li>Our servers are located in the United States</li>
                <li>Your data may be transferred to, stored, and processed in the US</li>
              </ul>

              <h3 className="text-xl font-semibold text-gray-200 mb-3">9.2 For European Users (GDPR)</h3>
              <p className="text-gray-300 mb-3">If you are in the European Economic Area (EEA):</p>
              <ul className="list-disc pl-6 text-gray-300 mb-4 space-y-1">
              ...
              <h3 className="text-xl font-semibold text-gray-200 mb-3">9.3 For California Users (CCPA)</h3>
              <p className="text-gray-300 mb-3">If you are a California resident:</p>
              <ul className="list-disc pl-6 text-gray-300 mb-4 space-y-1">
            ...
            <section className="mb-8">
              ...
              <p className="text-gray-300 mb-2"><strong>We will notify you of significant changes via:</strong></p>
              <ul className="list-disc pl-6 text-gray-300 mb-4 space-y-1">
            ...
            <section className="bg-primary-50 rounded-lg p-6">
              <h2 className="text-2xl font-bold text-gray-100 mb-4">Quick Summary</h2>

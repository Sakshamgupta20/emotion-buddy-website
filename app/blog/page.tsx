                ...
                <Link href={`/blog/${post.slug}`} className="group block">
                  <div className="grid md:grid-cols-2 gap-8 items-center bg-white rounded-3xl overflow-hidden shadow-xl hover:shadow-2xl transition-shadow border border-gray-100">
                    ...
                    <div className="p-6 md:p-10">
                      ...
                      <h2 className="h-card text-2xl md:text-3xl text-gray-900 mb-4 group-hover:text-purple-600 transition-colors">
                        {post.title}
                      </h2>
        ...
        <section className="py-12 md:py-16 bg-gray-50">
          <div className="max-w-6xl mx-auto px-4 sm:px-6">
            ...
            >
              ...
              <h2 className="h-card text-2xl md:text-3xl text-gray-900 mb-4">

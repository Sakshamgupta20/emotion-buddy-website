            ...
            <main className="flex-grow bg-transparent py-24">
                <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="glass-card p-8 md:p-12">
                        <h1 className="text-4xl font-bold gradient-text mb-4">Support & FAQ</h1>
                            ...
                            <div className="mb-8">
                                ...
                                <div className="space-y-4">
                                    <div className="border-l-4 border-primary-500 pl-4">
                                        <h4 className="font-semibold text-gray-100 mb-2">How do I create an account?</h4>
                                    ...
                                    <div className="border-l-4 border-primary-500 pl-4">
                                        <h4 className="font-semibold text-gray-100 mb-2">How do I reset my password?</h4>
                                        <p className="text-gray-300 text-sm">
                                    ...
                                    <div className="border-l-4 border-primary-500 pl-4">
                                        <h4 className="font-semibold text-gray-100 mb-2">How do I delete my account?</h4>
                                    ...
                                    <div className="border-l-4 border-primary-500 pl-4">
                                        <h4 className="font-semibold text-gray-100 mb-2">Can I change my email address?</h4>
                                        <p className="text-gray-300 text-sm">
                            ...
                            <div className="mb-8">
                                ...
                                <div className="space-y-4">
                                    <div className="border-l-4 border-blue-500 pl-4">
                                        <h4 className="font-semibold text-gray-100 mb-2">Is my journal data encrypted?</h4>
                                        <p className="text-gray-300 text-sm">
                                    ...
                                    <div className="border-l-4 border-blue-500 pl-4">
                                        <h4 className="font-semibold text-gray-100 mb-2">Where is my data stored?</h4>
                                        <p className="text-gray-300 text-sm">
                                    ...
                                    <div className="border-l-4 border-blue-500 pl-4">
                                        <h4 className="font-semibold text-gray-100 mb-2">Can I export my data?</h4>
                                        <p className="text-gray-300 text-sm">
                                    ...
                                    <div className="border-l-4 border-blue-500 pl-4">
                                        <h4 className="font-semibold text-gray-100 mb-2">What happens to my data if I delete my account?</h4>
                                        <p className="text-gray-300 text-sm mb-2">
                            ...
                            <div className="mb-8">
                                ...
                                <div className="space-y-4">
                                    <div className="border-l-4 border-purple-500 pl-4">
                                        <h4 className="font-semibold text-gray-100 mb-2">How does AI analysis work?</h4>
                                        <p className="text-gray-300 text-sm">
                                    ...
                                    <div className="border-l-4 border-purple-500 pl-4">
                                        <h4 className="font-semibold text-gray-100 mb-2">Can I disable AI features?</h4>
                                        <p className="text-gray-300 text-sm">
                                    ...
                                    <div className="border-l-4 border-purple-500 pl-4">
                                        <h4 className="font-semibold text-gray-100 mb-2">How do I add photos/videos to my journal?</h4>
                                        <p className="text-gray-300 text-sm">
                                    ...
                                    <div className="border-l-4 border-purple-500 pl-4">
                                        <h4 className="font-semibold text-gray-100 mb-2">How do mood tracking and analytics work?</h4>
                                        <p className="text-gray-300 text-sm">
                                    ...
                                    <div className="border-l-4 border-purple-500 pl-4">
                                        <h4 className="font-semibold text-gray-100 mb-2">Can I use Emotion Buddy offline?</h4>
                                        <p className="text-gray-300 text-sm">
                            ...
                            <div className="mb-8">
                                ...
                                <div className="space-y-4">
                                    <div className="border-l-4 border-green-500 pl-4">
                                        <h4 className="font-semibold text-gray-100 mb-2">Is Emotion Buddy free?</h4>
                                        <p className="text-gray-300 text-sm">
                                    ...
                                    <div className="border-l-4 border-green-500 pl-4">
                                        <h4 className="font-semibold text-gray-100 mb-2">Will there be paid features in the future?</h4>
                                        <p className="text-gray-300 text-sm">
                        ...
                        {/* Troubleshooting */}
                        <section className="mb-12">
                            <h2 className="text-2xl font-bold text-gray-100 mb-6">Troubleshooting Guide</h2>

                            <div className="space-y-6">
                                <div className="bg-transparent rounded-lg p-6">
                                    <h3 className="font-semibold text-gray-100 mb-3">🔧 App crashes or won't open</h3>
                                ...
                                <div className="bg-transparent rounded-lg p-6">
                                    <h3 className="font-semibold text-gray-100 mb-3">🔄 Sync issues or missing entries</h3>
                                    <ul className="list-disc pl-6 text-gray-300 space-y-2 text-sm">
                                ...
                                <div className="bg-transparent rounded-lg p-6">
                                    <h3 className="font-semibold text-gray-100 mb-3">🔐 Can't log in or "incorrect password" error</h3>
                                    <ul className="list-disc pl-6 text-gray-300 space-y-2 text-sm">
                                ...
                                <div className="bg-transparent rounded-lg p-6">
                                    <h3 className="font-semibold text-gray-100 mb-3">📱 Photos/videos won't upload</h3>
                                    <ul className="list-disc pl-6 text-gray-300 space-y-2 text-sm">
                                ...
                                <div className="bg-transparent rounded-lg p-6">
                                    <h3 className="font-semibold text-gray-100 mb-3">🤖 AI analysis not working</h3>
                                    <ul className="list-disc pl-6 text-gray-300 space-y-2 text-sm">
                        ...
                        <section className="mb-8">
                            <h2 className="text-2xl font-bold text-gray-100 mb-4">Additional Resources</h2>
                            <div className="grid md:grid-cols-2 gap-4">
                                ...
                                <Link
                                    ...
                                    className="bg-primary-50 hover:bg-primary-100 border border-primary-200 rounded-lg p-4 transition-colors"
                                >
                                    <h3 className="font-semibold text-gray-100 mb-1">Terms of Service</h3>
                                ...
                                <Link
                                    ...
                                    className="bg-primary-50 hover:bg-primary-100 border border-primary-200 rounded-lg p-4 transition-colors"
                                >
                                    <h3 className="font-semibold text-gray-100 mb-1">Data Deletion</h3>
                                    <p className="text-gray-400 text-sm">How to delete your account</p>
                                </Link>
                                <a
                                    href="/#download"
                                    className="bg-primary-50 hover:bg-primary-100 border border-primary-200 rounded-lg p-4 transition-colors"
                                >
                                    <h3 className="font-semibold text-gray-100 mb-1">Download App</h3>
                                    <p className="text-gray-400 text-sm">Get Emotion Buddy for iOS or Android</p>
                                </a>
                            </div>
                        </section>
                        ...
                        <section className="bg-gradient-to-r from-primary-50 to-blue-50 border border-primary-200 rounded-lg p-6">
                            <h2 className="text-xl font-bold text-gray-100 mb-3">Still Need Help?</h2>
                            ...
                            <div className="bg-white rounded-lg p-4">
                                ...
                                <ul className="list-disc pl-6 text-gray-400 text-sm space-y-1 mt-2">
